  ...
  static ThemeData get darkTheme {
    return ThemeData(
      ...
      textTheme: const TextTheme(
        headlineLarge: TextStyle(color: AppColors.text1, fontWeight: FontWeight.w700),
        headlineMedium: TextStyle(color: AppColors.text1, fontWeight: FontWeight.w600),
        titleLarge: TextStyle(color: AppColors.text1, fontWeight: FontWeight.w600),
        titleMedium: TextStyle(color: AppColors.text1, fontWeight: FontWeight.w500),
