  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(children: [
          _Dot(color: AppColors.accent, label: 'تطبيقات', value: '22G'),
          const SizedBox(width: 12),
          _Dot(color: AppColors.accent3, label: 'صور', value: '18G'),
          const SizedBox(width: 12),
          _Dot(color: AppColors.accent2, label: 'مستندات', value: '14G'),
        ]),
      ]),
    );
  }
