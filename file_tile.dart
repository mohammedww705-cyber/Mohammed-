...
class FileTile extends StatelessWidget {
  ...
  Color get _color {
    ...
    switch (file.category) {
      ...
      case FileCategory.apk: return AppColors.accent2;
      ...
      child: Container(
        ...
        child: Row(children: [
          ...
          if (!file.isDirectory) Container(
            ...
            child: Text(file.extension.toUpperCase(), style: TextStyle(color: _color, fontSize: 9, fontWeight: FontWeight.w600)),
          ),
